...
public class NewsDetailAdd implements Serializable {
    ...
    public static class Point implements Comparable {
        ...
        /**
         * @see com.news.qidian.net.request.UploadCommentRequest#TEXT_DOC
         * @see com.news.qidian.net.request.UploadCommentRequest#TEXT_PARAGRAPH
         * @see com.news.qidian.net.request.UploadCommentRequest#SPEECH_DOC
         * @see com.news.qidian.net.request.UploadCommentRequest#SPEECH_PARAGRAPH
         * */
        public String type;//
        public String up;
        public String down;
